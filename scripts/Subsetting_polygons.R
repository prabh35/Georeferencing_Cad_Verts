...
library(sf)               # for st_read , st_write, and st_layers functions
...
sf::st_layers("source_kml_shp/ProtectedAreas_CPCAD_Trial.shp")
...
sf::st_layers("source_kml_shp/LakesAndRivers_lhy_000c16a_f.shp")
...
sf::st_layers("source_kml_shp/CensusSubdivisions_lcsd000b16a_e.shp")
